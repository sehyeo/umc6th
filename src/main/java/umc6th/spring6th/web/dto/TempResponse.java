...
public class TempResponse {
    ...
    public static class TempExceptionDTO {
        ...
        public static class TempExceptionDTOBuilder {
            ...
            public String toString() {
                return "TempResponse.TempExceptionDTO.TempExceptionDTOBuilder(flag=" + this.flag + ")";
            }
        }
    }
    ...
    public static class TempTestDTO {
        ...
        public static class TempTestDTOBuilder {
            ...
            public String toString() {
                return "TempResponse.TempTestDTO.TempTestDTOBuilder(testString=" + this.testString + ")";
            }
        }
    }
}
